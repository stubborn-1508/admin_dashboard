      ...
      bg-center'>
        <div className='flex justify-between items-center'>
          <div>
            ...
            <p className='text-2xl'>$72,124.32</p>
          </div>
        </div>
        <div className='mt-6'>
          <Button 
        ...
        justify-center gap-1 items-center'>
          {earningData.map((item)=>(
            <div key={item.title}
            className="bg-white h-44 dark:text-gray-400 dark:bg-secondary-dark-bg
             md:w-56 p-4 pt-9 rounded-2xl">
               <button type='button' style={{backgroundColor:item.iconBg, color:item.iconColor}}
               className="text-2xl opacity-90 rounded-full
            ...
            <div className='border-r-1 border-color m-4 pr-10'>
              <div>
                <p>
                  ...
                  bg-green-400 ml-3 text-xs '>22%</span>
                </p>
              ...
              <div className='mt-10'>
                <Button color="white" byColor={currentColor} text="Download Report" borderRadius="10px"/>
              </div>
            </div>
            <div><Stacked width="320px" height="360 px"/></div>
          </div>
        </div>
      </div>
    </div>
